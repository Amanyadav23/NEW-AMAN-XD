...
Dᴇᴠᴇʟᴏᴘᴇᴅ Bʏ : [ƛMƛƝ](https://t.me/OFFICIAL_MENTALMOD)**.
        """,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💞 ᴏᴡɴᴇʀ ", url="https://t.me/OFFICIAL_MENTALMOD")
                  ],[
                    InlineKeyboardButton(
                        "🔥ƘƠƖ ƊƖƘƘƛƬ ӇƠ ƊM ƘƦ", url="https://t.me/OFFICIAL_MENTALMOD"
                    ),
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "ƁӇƠƧƊƖƘЄ ӇƲMƛƦƛ ƁƠƬ ƛƊƊ ƘƦԼƠ 🤭", url=f"https://t.me/http://t.me/MENTAL_MUSIC_BOT?startgroup=true"
                    )]4
            ]
        ),
...
async def gstart(_, message: Message):
      ...
      reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "😎 ᴜᴘᴅᴀᴛᴇs", url="https://t.me/OFFICIAL_MENTALMOD")
                ]
            ]
        )
   )
